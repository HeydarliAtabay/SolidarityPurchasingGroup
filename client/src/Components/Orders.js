import { Button, Row, Col, ListGroup, ListGroupItem, Image } from 'react-bootstrap';
    ...
    <Row>
      ...
      <Col xs={3} md={2}>
        <ListGroup variant="flush">
          <ListGroupItem>
            <Button variant="light" style={{ 'fontSize': 25, 'borderStyle': 'hidden', 'backgroundColor': "#b0e0e6" }}
              onClick={(event) => {
        ...
        <ListGroup variant="flush">
          <ListGroupItem key={"ciao"} variant={"secondary"} style={{ 'fontSize': 25, 'backgroundColor': "#b0e0e6" }}>List of my booked orders</ListGroupItem>
