      ...
      <div className="col-lg-3">
        ...
        <div className="card mx-3 my-5 shadow-sm">
          ...
          <div className="mx-3 text-center">
            <p className="mt-2">
              <a href="#">Apply</a> as a producer
            </p>
            <hr />
            <p>
              <a href="#">Apply</a> as a delivery worker
            </p>
          </div>
        </div>
        <hr></hr>
          ...
          <ul className="list-group list-group-flush">
            <li className="list-group-item">
              ...
              <p className="text-justify-custom">
                Who is behind The Beehive that says Yes! ? Get comfortable as we
                tell you our story, which began in 2015. We have summarized The
                Beehive in numbers and listed its values. But above all, what we
                want to share with you is that The Beehive that says Yes! it's a
                beautiful adventure made up of people. By the way, do you
                already know our team?
              </p>
            </li>
            <li className="list-group-item">
              <p className="text-center">
              ...
              <p className="text-justify-custom">
                Ours is a really good job: giving people the tools to eat better
                and supporting producers who take care of our planet.In our
                network, passionate men and women find new ways to work.The goal
                is not simple and the variations are different, but from north
                to south the spirit is always the same.Here it is summarized in
                our manifesto.
              </p>
            </li>
          </ul>
        ...
        <div className="card mx-3 my-5 shadow-sm">
          ...
          <ul className="list-group list-group-flush">
            <li className="list-group-item d-flex justify-content-between">
              <p>A map image should go here</p>
            </li>
          </ul>
        </div>
      </div>
