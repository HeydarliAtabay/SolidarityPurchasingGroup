...
function WarehouseEmployeeArea(props) {
        ...
        <div className="card m-3 d-block shadow">
          <div className="row no-gutters">
            <div
              ...
              style={{ backgroundColor: '#A6896F', borderRadius: '25px' }}
            >
              {pendingApps}
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">
                  Orders to be prepared for pick-up
                </h5>
                <p className="card-text">
                  • View &#38; prepare orders for pick-up
                  <br />
                  • Confirm order preparation
                  <br />
                </p>
                <div className="d-block text-end">
                  <Link to="/warehouse-prepare">
                    <button
                      className="btn"
...
export default WarehouseEmployeeArea;
